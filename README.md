...
| **Maturity review** | 2026-07-18 external review vs. 2026 KV-cache landscape (H2O/SnapKV/MLA/NEO/InfLLM etc.). M2 (real decode-throughput cost of host paging) **landed**: on Modal A100, re-paging every decode step is **2.2x–3.7x slower** than full-KV-resident decode (Qwen2.5-7B, S=8k–16k) — the 90–97% storage save is not free. Quality/competitive-baseline/MLA-composability validation still open — see `RESULTS.md` addendum and superproject ADR `2607182800-sqrt-space-kv-mla-composability-maturity-review.edn` |
